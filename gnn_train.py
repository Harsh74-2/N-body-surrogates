...
def main(cfg: TrainConfig, npz_path: str, out_dir: str) -> None:
    ...
    # cuDNN kernel autotuning (2026-09-21): shapes are constant per cell
    # (same N, batch, window) so the one-time benchmark on the first batch
    # locks in the fastest kernels for the rest of the run. Matters for
    # the cuDNN-RNN LSTM cells; harmless (near-noop) for the GNN.
